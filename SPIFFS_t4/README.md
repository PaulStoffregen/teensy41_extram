# teensy41 SPIFFS Library

**WARNING: If 2 PSRAM Chips are available on the T4.1 the second PSRAM chip is used for SPIFFS.  The first is available for Direct Memory Access for reads and writes!**
